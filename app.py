...
def create_app(config=DevConfig):
    ...
    db.init_app(app)
    CORS(app, resources={r"/api/*": {"origins": ["http://localhost:5173", "https://workforceflows.netlify.app"]}})
...
# Initialize extensions
jwt = JWTManager(app)
CORS(app, origins=["http://localhost:5173", "https://workforceflows.netlify.app"])
db.init_app(app)
migrate.init_app(app, db)
